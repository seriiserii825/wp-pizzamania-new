		...
		<div class="container">
			<div class="row">
				...
				<p class="c_conctacts">
					...
					<a href="tel:<?php the_field('phone1', 'options'); ?>" class="c_conctacts_first"> <?php the_field('phone1', 'options'); ?></a>
					<i class="flaticon-phone-call"></i> 
					<a href="tel:<?php the_field('phone2', 'options'); ?>" class="c_conctacts_first"> <?php the_field('phone2', 'options'); ?></a>
					<i class="flaticon-phone-call"></i>
					<a href="tel:<?php the_field('phone3', 'options'); ?>"> <?php the_field('phone3', 'options'); ?></a>
					</p>
				</div>
				<div class="col-md-5 hidden-xs">
				<p class="c_grafik"><!--<?php pll_e('График доставки'); ?>:--> <span><i class="flaticon-placeholder"></i> <?php pll_e('Кишинев'); ?> <?php the_field('dostavka_chishnau', 'options'); ?></span><span><i class="flaticon-placeholder"></i> <?php pll_e('Бельцы'); ?> <?php the_field('dostavka_balti', 'options'); ?></span></p>
				</div>
...
?>
							...
							<div class="nav-right-block">
								<ul class="list-unstyled">
									<li id="open"><a href="#"><i class="flaticon-scooter-front-view"></i><span class="nav-price"><?php pll_e('Товаров'); ?>: <div class="label-place"></div></span></a></li>
								</ul>
							</div><!-- nav-login -->
						</div>
					</div>
		...
		<div class="banner slider1 new-block">
			<div class="fixed-bg" style="background: url('<?php echo get_template_directory_uri(); ?>/images/slider-bg1.jpg');"></div>
